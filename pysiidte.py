...
normalize_tags['TpoDoc'] = [100]
normalize_tags['NroDoc'] = [100]
normalize_tags['TpoImp'] = [100]
normalize_tags['TasaImp'] = [100]
normalize_tags['FchDoc'] = [100]
normalize_tags['RUTDoc'] = [100]
...
normalize_tags['MntIVA'] = [18]
normalize_tags['OtrosImp'] = [18]
normalize_tags['CodImp'] = [18]
...
normalize_tags['IVANoRec'] = [18]
normalize_tags['CodIVANoRec'] = [18]
normalize_tags['MntIVANoRec'] = [18]
normalize_tags['IVANoRet'] = [18]
normalize_tags['IVAUsoComun'] = [18]
normalize_tags['MntSinCred'] = [18]
...
normalize_tags['IVANoRetenido'] = [18]
